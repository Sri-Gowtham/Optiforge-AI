        ...
        <div className="h-screen w-64 bg-slate-dark text-white fixed left-0 top-0 flex flex-col shadow-xl">
            ...
            <div className="p-6 border-b border-slate-medium">
                <Link href="/dashboard">
                    ...
                    <p className="text-sm text-gray-400 mt-1">Design Optimization</p>
                </Link>
            </div>
                        ...
                        <li key={item.path}>
                            <Link
                                ...
                                className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 ${isActive(item.path)
                                        ...
                                        : 'hover:bg-slate-medium text-gray-300 hover:text-white'
                                    }`}
                            >
            ...
            {/* Footer */}
            <div className="p-4 border-t border-slate-medium">
