...
const FormInput: React.FC<FormInputProps> = ({
    ...
    return (
        <div className="mb-4">
            ...
            <div className="relative">
                ...
                {isPasswordField && (
                    <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-medium hover:text-slate-dark transition-colors"
            ...
            {helperText && !error && (
                <p className="mt-1.5 text-sm text-slate-medium">{helperText}</p>
            )}
        </div>
    );
};
